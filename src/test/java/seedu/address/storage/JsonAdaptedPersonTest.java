...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_PHONE, VALID_EMAIL,
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, null, VALID_EMAIL,
                VALID_ADDRESS, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person =  JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, null,
                VALID_ADDRESS, VALID_REMARK, VALID_TAGS);;
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
